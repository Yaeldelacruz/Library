...
@section('body')
    <div class="grid grid-cols-2 grid-flow-row">
        ...
        <div class="text-center">
            <button type="submit" class="text-blue-600 text-lg border border-blue-600 bg-white hover:bg-blue-600 hover:text-white rounded-md px-4 py-2 my-10">Subir pais</button>
        </div>
    </div>
@endsection